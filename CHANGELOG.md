...
### Added
- First-class page URL context for templates: `page.url`, `page.filename`, `page.permalink`, and `page.canonical_url`
- Canonical URL fields on index template items: `item.url`, `item.permalink`, and `item.canonical_url`
- Current page URL context for index templates, enabling shared canonical/Open Graph head templates

### Changed
- Sitemap content URL generation now shares the same output-path-to-URL logic used by template context
...
[1.7.0]: https://github.com/vectorian-rs/marie-ssg/compare/v1.6.0...v1.7.0
